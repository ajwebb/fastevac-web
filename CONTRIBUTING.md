...
Please read the following guidelines before you [report an issue](https://github.com/ajwebb/FastEvac/issues):
...
**[File a bug report](https://github.com/ajwebb/FastEvac/issues)**
...
2. Clone your fork (`git clone
   https://github.com/<your-username>/FastEvac.git`).
